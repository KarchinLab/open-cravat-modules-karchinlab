...
class CravatAnnotator (BaseAnnotator):
                                                                                              ...
                                                                                              101    56    95   110    Lys
                                                                                                     45   160   181    Asp
                                                                                                          126   152    Glu
                                                                                                                 67    Met
    """
    aa_list = ['Ser', 'Arg', 'Leu', 'Pro', 'Thr', 'Ala', 'Val', 'Gly', 'Ile', 'Phe', 'Tyr', 'Cys', 'His', 'Gln', 'Asn',
                'Lys', 'Asp', 'Glu', 'Met', 'Trp']
    scores = [
    ...
    def annotate(self, input_data):
        ...
        if so != 'missense_variant':
            return {}
        achange = input_data.get('achange')
        # ex: p.Ser207Cys
        left = achange[2:5]
        right = achange[-3:]
        l_index = self.aa_list.index(left)
        r_index = self.aa_list.index(right)
        return {
            'score': self.scores[l_index][r_index]
        }
