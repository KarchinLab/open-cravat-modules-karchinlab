widgetGenerators['phastcons'] = {
	'variant': {
		...
		'function': function (div, row, tabName) {
			...
			addInfoLine(div, 'Mammalian Score', getWidgetData(tabName, 'phastcons', row, 'phastcons470_mamm'), tabName);
			addInfoLine(div, 'Mammalian Ranked Score', getWidgetData(tabName, 'phastcons', row, 'phastcons470_mamm_r'), tabName);
